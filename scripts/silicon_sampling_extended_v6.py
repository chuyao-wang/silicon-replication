...
def generate_backstory(row, mode='v5_clean'):
    ...
    include_ses = mode not in ('minimal',)
    include_political_vars = mode not in ('minimal', 'ses')
...
def load_data(ess_file=None, countries=None, sample_per_country=None, seed=888,
    ...
    backstory_mode : str
        'v5_clean' (20 vars, default), 'minimal' (4), 'ses' (14),
...
Examples:
  ...
  python silicon_sampling_extended_v5.py --block full --countries GB
    ...
    parser.add_argument('--backstory', type=str, default='v5_clean',
                        choices=['v4', 'v5', 'v5_clean', 'minimal', 'ses', 'political', 'full_clean'],
                        help='Backstory mode: v5_clean (20 vars, default), minimal (4), ses (14), political (16), full_clean (=v5_clean), v4 (17, leaked), v5 (27, leaked)')
    ...
    BACKSTORY_DESC = {'v4': '17 variables (leaked)', 'v5': '27 variables (leaked)',
                      'v5_clean': '20 variables (clean)', 'minimal': '4 variables',
