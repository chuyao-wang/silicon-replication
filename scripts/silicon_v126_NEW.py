...
def generate_backstory(row, mode='v5_clean'):
    ...
    include_v5_extras = mode in (('v5', 'v5_clean', 'full_clean', 'full_nocountry', 'full_noregion', 'full_nopolitical', 'full_noincome', 'full_swapcountry', 'minimal_household', 'minimal_membership', 'minimal_minority') + _LOGO_MODES)  # v10 CHANGE; v12.4 adds the LOGO arms
    ...
    if include_v5_extras or mode == 'minimal_politics_econ':  # v12.3
        ...
        mbtru = _safe_int(row.get('mbtru')) if _logo != 'full_nomembership' and _ok('member') else None  # v12.5/12.6
        if mbtru == 1:
        ...
        netusoft = _safe_int(row.get('netusoft')) if _logo != 'full_nomembership' and _ok('member') else None  # v12.5/12.6
