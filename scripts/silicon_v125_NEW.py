...
def generate_backstory(row, mode='v5_clean'):
    ...
    if include_v5_extras or mode == 'minimal_politics_econ':  # v12.3
        ...
        mbtru = _safe_int(row.get('mbtru')) if _logo != 'full_nomembership' else None  # v12.5
        if mbtru == 1:
        ...
        dscrgrp = _safe_int(row.get('dscrgrp')) if include_v5_extras and _logo != 'full_nominority' else None  # v12.5
        if dscrgrp == 1:
        ...
        netusoft = _safe_int(row.get('netusoft')) if _logo != 'full_nomembership' else None  # v12.5
