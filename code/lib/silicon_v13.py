...
# v13.2 (2 Aug 2026): the regrouped ladder. The March grouping put a single
# variable in the "political" rung and fourteen in the last one; the rungs
# below are named blocks, and the political rung is the SAME two variables
# the full_nopolitical ablation removes, so the chapter has one definition of
# "political". The superseded arms are kept under LADDER_SUPERSEDED because
# their summaries ship and REPRODUCTION.csv still compares them.
LADDER = {
    "qwen_1p_demo_only": ("demo_only", 3),
    "qwen_1p_minimal": ("minimal", 4),
    "qwen_1p_minimal_politics": ("minimal_politics", 6),
    "qwen_1p_minimal_politics_econ": ("minimal_politics_econ", 12),
